...
Cite a paper by multiple authors with a period in the first author's name [@zebra2003; @zebra2004]. This results in two entries for Zebra 2003, and a suppressed set of names for Zebra 2002 (but without the expected --------).
